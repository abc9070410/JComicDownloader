...
public class ParseIshuhui extends ParseOnlineComicSite {
    ...
    public ParseIshuhui() {
        ...
        jsName = "index_ishuhui.js";
        radixNumber = 1037441; // default value, not always be useful!!

        baseURL = "http://www.ishuhui.com";
    }

    public ParseIshuhui( String webSite, String titleName ) {
        this();
